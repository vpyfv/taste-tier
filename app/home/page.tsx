  ...
  return (
    <div className="flex items-center h-screen">
      <div className="w-1/3 text-text-color-p">
        <div className="text-5xl font-bold ml-20 mb-6">People of columbia picked their favourite restaurants</div>
        <div className="text-end ">it wont be same if you disagree</div>
        <div className="text-end mt-4 ">Rate Now</div>
      </div>
      <div className="w-1/2 ml-20 mt-28 h-4/5 overflow-y-scroll relative">
